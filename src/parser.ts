...
function parseTopLevel(lines: Line[], index: number, config: DrxConfig, file?: string) {
  const line = lines[index]
...
function collectFunctionBody(lines: Line[], start: number, config: DrxConfig, file?: string) {
